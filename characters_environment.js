...
function game(){
  ...
  if(gameConfig.status==='gameover'){
    ...
    textSize(30);
    textAlign(CENTER);
    text("YOU HAVE PERISHED AND HAVE FELL INTO THE DEEPEST REALM OF HELL.", gameConfig.screenX/2, gameConfig.screenY/2+105);
    textSize(15);
    text("Press SPACE to Restart as another disgrace", gameConfig.screenX/2, gameConfig.screenY/2+135);
    textSize(40);
